...
const translations: Record<string, Record<"en" | "mr", string>> = {
  ...
  // Dashboard Page
  today_sales: { en: "Today's sales", mr: "आजची विक्री" },
  today_profit: { en: "Today's profit", mr: "आजचा नफा" },
  bills_today: { en: "Bills today", mr: "आजची बिले" },
  needs_attention: { en: "Needs attention", mr: "लक्ष द्या" },
  view_all: { en: "View all", mr: "सर्व पहा" },
  todays_sales_activity: { en: "Today's sales activity", mr: "आजची विक्री" },
  business_intelligence: { en: "Business intelligence", mr: "व्यवसाय माहिती" },
  inventory_health: { en: "Inventory health", mr: "स्टॉक स्थिती" },
  money_to_recover: { en: "Money to recover", mr: "वसूल करायची रक्कम" },
  expiry_alerts: { en: "Expiry alerts", mr: "एक्सपायरी सूचना" },
  view_report: { en: "View report", mr: "अहवाल पहा" },
  this_week: { en: "This week", mr: "या आठवड्यात" },
